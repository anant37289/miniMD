...
void Main::_serial_1(CkReductionMsg* gen0) {
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Main_serial_1()), CkMyPe(), 0, NULL, this); 
  {
    CkReductionMsg*& msg = gen0;
    { // begin serial block
#line 61 "/u/ajain18/miniMD/charm/ljs.ci"
...
void Main::_serial_2() {
  ...
  { // begin serial block
#line 76 "/u/ajain18/miniMD/charm/ljs.ci"

        CkPrintf("[Main] Blocks initialized\n");
        block_proxy.run();
      
#line 1185 "miniMD.def.h"
  } // end serial block
  _TRACE_END_EXECUTE(); 
  _when_2_end();
}
...
void Main::_serial_3() {
  ...
  { // begin serial block
#line 80 "/u/ajain18/miniMD/charm/ljs.ci"

        CkPrintf("[Main] Blocks complete\n");
        kokkos_proxy.finalize();
      
#line 1227 "miniMD.def.h"
  } // end serial block
  _TRACE_END_EXECUTE(); 
  _when_3_end();
}
...
void Main::_serial_4() {
  ...
  { // begin serial block
#line 84 "/u/ajain18/miniMD/charm/ljs.ci"

        CkPrintf("[Main] Kokkos finalized\n");
        CkExit();
      
#line 1269 "miniMD.def.h"
  } // end serial block
  _TRACE_END_EXECUTE(); 
  _when_4_end();
}
