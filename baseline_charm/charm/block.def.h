    ...
    struct Closure_Block::init_2_closure : public SDAG::Closure {
      ...
      init_2_closure(CkMigrateMessage*) {
        init();
            ...
            CkArrayID & getP0() { return comm_array_id;}
      void pup(PUP::er& __p) {
        __p | comm_array_id;
        packClosure(__p);
      }
...
/* ---------------- method closures -------------- */
    ...
    struct Closure_Comm::commReady_2_closure : public SDAG::Closure {
      

      commReady_2_closure() {
        init();
      }
      commReady_2_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~commReady_2_closure() {
      }
      PUPable_decl(SINGLE_ARG(commReady_2_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: void init(const CkArrayID &comm_array_id);
 */
void CProxyElement_Block::init(const CkArrayID &comm_array_id, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const CkArrayID &comm_array_id
  int impl_off=0;
  { //Find the size of the PUP'd data
    PUP::sizer implP;
    //Have to cast away const-ness to get pup routine
    implP|(typename std::remove_cv<typename std::remove_reference<CkArrayID>::type>::type &)comm_array_id;
    impl_off+=implP.size();
  }
  ...
  ckSend(impl_amsg, CkIndex_Block::idx_init_marshall2(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void init(const CkArrayID &comm_array_id);
 */
void CProxy_Block::init(const CkArrayID &comm_array_id, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const CkArrayID &comm_array_id
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_init_marshall2(),0);
}

// Entry point registration function
int CkIndex_Block::reg_init_marshall2() {
  int epidx = CkRegisterEp("init(const CkArrayID &comm_array_id)",
      reinterpret_cast<CkCallFnPtr>(_call_init_marshall2), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_init_marshall2);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_init_marshall2);

  return epidx;
}

void CkIndex_Block::_call_init_marshall2(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const CkArrayID &comm_array_id*/
  PUP::fromMem implP(impl_buf);
  PUP::detail::TemporaryObjectHolder<CkArrayID> comm_array_id;
  implP|comm_array_id;
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
  impl_obj->init(std::move(comm_array_id.t));
}
int CkIndex_Block::_callmarshall_init_marshall2(char* impl_buf, void* impl_obj_void) {
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
...
void CkIndex_Block::_marshallmessagepup_init_marshall2(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const CkArrayID &comm_array_id*/
  ...
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
  if (implDestP.hasComments()) implDestP.comment("comm_array_id");
  implDestP|comm_array_id;
}
...
/* DEFS: void init(const CkArrayID &comm_array_id);
 */
void CProxySection_Block::init(const CkArrayID &comm_array_id, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const CkArrayID &comm_array_id
  int impl_off=0;
...
void CkIndex_Block::__register(const char *s, size_t size) {
  ...
  // REG: void init(const CkArrayID &comm_array_id);
  idx_init_marshall2();
...
void Block::_serial_0(Closure_Block::reducesum_6_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_0()), CkMyPe(), 0, &projID, this); 
  {
    ...
    { // begin serial block
#line 114 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
...
void Block::_serial_1(Closure_Block::temperature_allreduce_7_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_1()), CkMyPe(), 0, &projID, this); 
  {
    ...
    { // begin serial block
#line 124 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        int tag = comm->iter;
        thisProxy[0].reducesum(tag, thermo.t_act);
      
#line 7580 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _when_0(gen0);
...
void Block::_serial_2(Closure_Block::temperature_allreduce_7_closure* gen0, Closure_Block::temperature_recv_8_closure* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_2()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    {
      ...
      { // begin serial block
#line 128 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        thermo.t1 = t1;
      
#line 7644 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_3(Closure_Block::temperature_allreduce_7_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_3()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 131 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 7665 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_1_end(gen0);
...
void Block::_serial_4(Closure_Block::energy_allreduce_9_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_4()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 137 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
...
void Block::_serial_5(Closure_Block::energy_allreduce_9_closure* gen0, CkReductionMsg* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_5()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    {
      CkReductionMsg*& msg = gen1;
      { // begin serial block
#line 143 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        thermo.eng = *(MMD_float*)msg->getData();
      
#line 7805 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_6(Closure_Block::energy_allreduce_9_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_6()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 146 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 7826 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_2_end(gen0);
...
void Block::_serial_7(Closure_Block::pressure_allreduce_11_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_7()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 152 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
...
void Block::_serial_8(Closure_Block::pressure_allreduce_11_closure* gen0, CkReductionMsg* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_8()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    {
      CkReductionMsg*& msg = gen1;
      { // begin serial block
#line 158 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        thermo.virial = *(MMD_float*)msg->getData();
      
#line 7966 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_9(Closure_Block::pressure_allreduce_11_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_9()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 161 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 7987 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_3_end(gen0);
...
void Block::_serial_10(Closure_Block::mark_start_13_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_10()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 167 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        CkCallback cb_start(CkReductionTarget(Block, markstart_recv), thisProxy[0]);
        contribute(cb_start);
      
#line 8055 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _when_3(gen0);
...
void Block::_serial_11(Closure_Block::mark_start_13_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_11()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 171 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 8101 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _when_3_end(gen0);
...
void Block::_serial_12() {
  ...
  { // begin serial block
#line 177 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        start_time = CkWallTimer();
        thisProxy.start_iterations();
      
#line 8151 "block.def.h"
  } // end serial block
  _TRACE_END_EXECUTE(); 
  _slist_5_end();
}
...
void Block::_serial_13(Closure_Block::mark_done_16_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_13()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 183 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        CkCallback cb_done(CkReductionTarget(Block, markdone_recv), thisProxy[0]);
        contribute(cb_done);
      
#line 8218 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _when_4(gen0);
...
void Block::_serial_14(Closure_Block::mark_done_16_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_14()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 187 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 8264 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _when_4_end(gen0);
...
void Block::_serial_15() {
  ...
  { // begin serial block
#line 193 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
...
void Block::_serial_16(Closure_Block::exchange_notify_recv_ready_19_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_16()), CkMyPe(), 0, &projID, this); 
  {
    ...
    { // begin serial block
#line 201 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
...
void Block::_serial_19(Closure_Block::exchange_recv_ready_wait_20_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_19()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    { // begin serial block
#line 217 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 8593 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_9_end(gen0);
...
void Block::_serial_20(Closure_Block::exchange_2_send_1_21_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_20()), CkMyPe(), 0, &projID, this); 
  {
    ...
    { // begin serial block
#line 222 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
        ...
        if(comm->send1_size==0)
          thisProxy[comm->send1_chare].exchange_2_recv_1(tag, sizeof(MMD_float)*4, true, CkDeviceBuffer((char*)comm->buf_comm_dummy, hapi_stream(pack_instance)));
        else
          thisProxy[comm->send1_chare].exchange_2_recv_1(tag, comm->send1_size, false, CkDeviceBuffer((char*)comm->send1, cb, hapi_stream(pack_instance)));
        cb_thread.send();
      
#line 8662 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_11_end(gen0);
...
void Block::_serial_21(Closure_Block::exchange_2_send_2_22_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_21()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb_thread = gen0->getP1();
    { // begin serial block
#line 234 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

          int tag = 3*comm->iter + idim;
          CkArrayIndex1D myIndex = CkArrayIndex1D(thisIndex);
          CkCallback cb(CkIndex_Block::send_done(), myIndex, thisArrayID);
          if(comm->send2_size==0)
            thisProxy[comm->send2_chare].exchange_2_recv_2(tag, sizeof(MMD_float)*4, true, CkDeviceBuffer((char*)comm->buf_comm_dummy, hapi_stream(pack_instance)));
          else
            thisProxy[comm->send2_chare].exchange_2_recv_2(tag, comm->send2_size, false, CkDeviceBuffer((char*)comm->send2, cb, hapi_stream(pack_instance)));
          cb_thread.send();
      
#line 8731 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_12_end(gen0);
...
void Block::_serial_22(Closure_Block::exchange_2_recv_1_wait_23_closure* gen0, Closure_Block::exchange_2_recv_1_28_closure* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_22()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    {
      ...
      { // begin serial block
#line 246 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 8849 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_23(Closure_Block::exchange_2_recv_2_wait_24_closure* gen0, Closure_Block::exchange_2_recv_2_29_closure* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_23()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    {
      ...
      char* data = (char*) (deviceBuffer_data.ptr);
      { // begin serial block
#line 251 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 8968 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_24(Closure_Block::send_done_wait_25_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_24()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    { // begin serial block
#line 262 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 9162 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_15_end(gen0);
...
void Block::_serial_26(Closure_Block::borders_recv_ready_wait_31_closure* gen0, Closure_Block::borders_recv_1_33_closure* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_26()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    {
      int& ref = gen1->getP0();
      { // begin serial block
#line 278 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 9339 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_27(Closure_Block::borders_2_32_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_27()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    { // begin serial block
#line 283 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        int tag = comm->maxswap_static*comm->iter + iswap;
        CkArrayIndex1D myIndex = CkArrayIndex1D(thisIndex);
        CkCallback cb(CkIndex_Block::send_done(), myIndex, thisArrayID);
        thisProxy[comm->send1_chare].borders_recv_2(tag, comm->send1_size, CkDeviceBuffer((char*)comm->send1, cb, hapi_stream(pack_instance)));
      
#line 9412 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _when_12(gen0);
...
void Block::_serial_28(Closure_Block::borders_2_32_closure* gen0, Closure_Block::borders_recv_2_34_closure* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_28()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    {
      ...
      char* data = (char*) (deviceBuffer_data.ptr);
      { // begin serial block
#line 290 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

            cb.send();
        
#line 9508 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_29(Closure_Block::comms_notify_recv_ready_35_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_29()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP2();
    { // begin serial block
#line 297 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        int tag = comm->nswap*iter + iswap;
        thisProxy[comm->recvchare[iswap]].comms_recv_1(tag);
        cb.send();
      
#line 9575 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_21_end(gen0);
...
void Block::_serial_30(Closure_Block::comms_recv_ready_wait_36_closure* gen0, Closure_Block::comms_recv_1_37_closure* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_30()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    {
      int& ref = gen1->getP0();
      { // begin serial block
#line 304 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

        cb.send();
      
#line 9688 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_31(Closure_Block::comms_send_38_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_31()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    { // begin serial block
#line 310 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

          int tag = comm->nswap*comm->iter + iswap;
          CkArrayIndex1D myIndex = CkArrayIndex1D(thisIndex);
          CkCallback cb(CkIndex_Block::send_done(), myIndex, thisArrayID);
          thisProxy[comm->send1_chare].comms_recv(tag, comm->send1_size, CkDeviceBuffer((char*)comm->send1, cb, hapi_stream(pack_instance)));
        
#line 9761 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _when_15(gen0);
...
void Block::_serial_32(Closure_Block::comms_send_38_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_32()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    { // begin serial block
#line 316 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

          cb.send();
        
#line 9808 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _when_15_end(gen0);
...
void Block::_serial_33(Closure_Block::comms_recv_wait_39_closure* gen0, Closure_Block::comms_recv_40_closure* gen1) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_33()), CkMyPe(), 0, &projID, this); 
  {
    ...
    CkCallback& cb = gen0->getP1();
    {
      ...
      char* data = (char*) (deviceBuffer_data.ptr);
      { // begin serial block
#line 321 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"

          cb.send();
        
#line 9925 "block.def.h"
      } // end serial block
    }
  }
  _TRACE_END_EXECUTE(); 
...
void Block::_serial_34(Closure_Block::comm_all_42_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_34()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 328 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
      ...
      {
        {
          ...
          { // begin serial block
#line 342 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
            ...
            hapiCheck(hapiEventRecord(dep_event, hapi_stream(comm->h2d_instance)));
            hapiCheck(hapiStreamWaitEvent(hapi_stream(comm->unpack_instance), dep_event, 0));
...
void Block::_serial_36(Closure_Block::comm_all_42_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_36()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 353 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
 cb.send(); 
#line 10192 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_25_end(gen0);
...
void Block::_serial_37(Closure_Block::comm_rev_all_44_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_37()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 357 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
      ...
      {
        {
          ...
          size_t& size = gen3->getP2();
          { // begin serial block
#line 371 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
...
void Block::_serial_39(Closure_Block::comm_rev_all_44_closure* gen0) {
  ...
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_Block_serial_39()), CkMyPe(), 0, &projID, this); 
  {
    CkCallback& cb = gen0->getP0();
    { // begin serial block
#line 383 "/ccs/home/rrao/miniMD/baseline_charm/charm/ljs.ci"
 cb.send(); 
#line 10459 "block.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_28_end(gen0);
...
/* DEFS: void commReady();
 */
void CProxyElement_Comm::commReady(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Comm::idx_commReady_void(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void commReady();
 */
void CProxy_Comm::commReady(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Comm::idx_commReady_void(),0);
}

// Entry point registration function
int CkIndex_Comm::reg_commReady_void() {
  int epidx = CkRegisterEp("commReady()",
      reinterpret_cast<CkCallFnPtr>(_call_commReady_void), 0, __idx, 0);
  return epidx;
}

void CkIndex_Comm::_call_commReady_void(void* impl_msg, void* impl_obj_void)
{
  Comm* impl_obj = static_cast<Comm*>(impl_obj_void);
  impl_obj->commReady();
  if(UsrToEnv(impl_msg)->isVarSysMsg() == 0)
...
PUPable_def(SINGLE_ARG(Closure_Comm::commReady_2_closure))
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void commReady();
 */
void CProxySection_Comm::commReady(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
