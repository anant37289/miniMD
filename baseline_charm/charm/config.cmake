...
set(CHARM_DIR "/u/ajain18/oldCharm/multicore-linux-x86_64-cuda")
...
set(GPU_OPTS "-O0 -g -std=c++20 -extended-lambda -Wext-lambda-captures-this")
set(GPU_LINK_OPTS "-O0 -std=c++20 -lcudart -lcuda -L${KOKKOS_DIR}/lib64 -lkokkoscore -lkokkoscontainers -lkokkosalgorithms -lkokkossimd")
